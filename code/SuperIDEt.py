    ...
    def __init__(self, parent):
        ...
        for i in range(1, 5):
            ...
            if not match:
                ...
                continue
            func_key, icon_name = match.groups()
...
class IDE(QMainWindow):
    def __init__(self, filename=None):
        super().__init__()
        self.setWindowTitle("GCBASIC Essential IDE 1.7")
        config_dir = os.path.expanduser("~/.superide")
    ...
    def init_ui(self):
        ...
        reset_button_bar_action = QAction("Reset Button Bar Position", self)
        ...
        about_action.triggered.connect(lambda: QMessageBox.information(self, "About", "GCBASIC Essential IDE v1.7"))
