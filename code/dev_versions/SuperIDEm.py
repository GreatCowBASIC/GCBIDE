# issues
# - None (Tasks to Menu option, duplicate execute_task, syntax error, F4 shortcut, check_file_changes invocation, external file change detection, reload prompt after save, and double tab closure issues resolved).
...
class IDE(QMainWindow):
    ...
    def parse_tasks_json(self, file_path):
        """Parse tasks.json, handling comments by reading line by line."""
        try:
    ...
    def check_file_changes(self, text_edit):
        #self.terminal.log("def check_file_changes")
