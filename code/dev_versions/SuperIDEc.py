...
class CustomTextEdit(QTextEdit):
    ...
    def show_context_menu(self, position):
        ...
        # Apply stylesheet to match other menus
...
class IDE(QMainWindow):
    def __init__(self, filename=None):
        ...
        self.tabs.setMovable(True)  # Enable drag-and-drop reordering of tabs
    ...
    def apply_theme(self):
        if self.settings["theme"] == "dark":
            fg_color = "#FFFFFF"  # White text for dark theme
            bg_color = "#2E2E2E"  # Dark gray background
            hover_color = "#555555"  # Medium gray for hover
            border_color = "#444444"  # Subtle border
        else:
            fg_color = "#000000"  # Black text for light theme
            bg_color = "#F5F5F5"  # Light gray background
            hover_color = "#D3D3D3"  # Light gray for hover
    ...
    def apply_text_settings(self, text_edit=None):
        ...
        if text_edit is None:
            ...
            # Set font for CustomTextEdit and its document
            ...
            # Set stylesheet for text color
            text_edit.setStyleSheet(f"background: transparent; color: {fg_color};")
            # Force line number area to update
            text_edit.line_number_area.update()
    ...
    def load_settings(self):
        ...
        try:
            with open(settings_path, "r", encoding="utf-8") as f:
                ...
                # Ensure editor_font_size has a valid default
