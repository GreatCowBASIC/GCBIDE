...
class IDE(QMainWindow):
    def __init__(self, filename=None):
        ...
        if os.path.exists(icon_path):
            ...
            self.terminal.log(f"Application icon loaded from {icon_path}", "INFO")
        else:
    ...
    def init_ui(self):
        ...
        recent_files_menu.addAction("List Recent Files").triggered.connect(self.show_recent_files_in_settings)
